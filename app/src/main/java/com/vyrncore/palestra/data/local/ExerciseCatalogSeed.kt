...
object ExerciseCatalogSeed {
    ...
    private val seeds: List<Seed> = listOf(
        // ---- Petto ----
        Seed("a10c9b1e-1111-4a11-8000-000000000001", "Panca piana", "Petto", "Bilanciere", ExerciseDifficulty.INTERMEDIO, "Scapole retratte e piedi ben piantati: tocca il petto senza rimbalzi."),
        ...
        Seed("a10c9b1e-1111-4a11-8000-000000000003", "Croci ai cavi", "Petto", "Cavi", ExerciseDifficulty.PRINCIPIANTE, "Movimento ad arco costante, spremi al centro per un secondo prima di tornare."),
        ...
        Seed("a10c9b1e-1111-4a11-8000-000000000006", "Chest press alle macchine", "Petto", "Macchina", ExerciseDifficulty.PRINCIPIANTE, "Maniglie all'altezza del petto, spalle contro lo schienale per tutta la serie."),
        ...
        // ---- Dorso ----
        Seed("a10c9b1e-1111-4a11-8000-000000000009", "Trazioni alla lat machine", "Dorso", "Lat machine", ExerciseDifficulty.PRINCIPIANTE, "Porta la sbarra al petto, non dietro la testa: le spalle ti ringrazieranno."),
        ...
        Seed("a10c9b1e-1111-4a11-8000-00000000000e", "Pulley basso", "Dorso", "Cavi", ExerciseDifficulty.PRINCIPIANTE, "Busto fermo: le spalle si spostano solo all'indietro, non il tronco."),
        ...
        Seed("a10c9b1e-1111-4a11-8000-000000000014", "Leg press", "Gambe", "Macchina", ExerciseDifficulty.PRINCIPIANTE, "Lombardia incollata allo schienale: non bloccare le ginocchia in estensione."),
        ...
        Seed("a10c9b1e-1111-4a11-8000-000000000016", "Leg curl", "Gambe", "Macchina", ExerciseDifficulty.PRINCIPIANTE, "Anca ben premuta sul pancale: contra i femorali per un secondo a fine corsa."),
        Seed("a10c9b1e-1111-4a11-8000-000000000017", "Leg extension", "Gambe", "Macchina", ExerciseDifficulty.PRINCIPIANTE, "Estensione completa con pausa in alto: il movimento parte dal quadricipite, non dalla schiena."),
        Seed("a10c9b1e-1111-4a11-8000-000000000018", "Polpacci in piedi", "Gambe", "Macchina", ExerciseDifficulty.PRINCIPIANTE, "Massimo allungamento in basso, punta massima in alto: range completo sempre."),
        ...
        Seed("a10c9b1e-1111-4a11-8000-00000000001a", "Hack squat", "Gambe", "Macchina", ExerciseDifficulty.INTERMEDIO, "Schiena interamente contro lo schienale: profondità piena senza sollevare i talloni."),
        ...
        Seed("a10c9b1e-1111-4a11-8000-00000000001c", "Polpacci seduto", "Gambe", "Macchina", ExerciseDifficulty.PRINCIPIANTE, "Colpisce il soleo: ripetizioni lente e controllate, pausa in alto."),
        ...
        Seed("a10c9b1e-1111-4a11-8000-00000000004a", "Corsa su tapis roulant", "Cardio", "Tapis roulant", ExerciseDifficulty.PRINCIPIANTE, "Non tenere le maniglie: inclinazione 1-2% per simulare la corsa outdoor."),
        Seed("a10c9b1e-1111-4a11-8000-00000000004b", "Cyclette", "Cardio", "Cyclette", ExerciseDifficulty.PRINCIPIANTE, "Regola la sella all'altezza dell'anca: il ginocchio resta leggermente flesso in basso."),
        Seed("a10c9b1e-1111-4a11-8000-00000000004c", "Vogatore", "Cardio", "Vogatore", ExerciseDifficulty.INTERMEDIO, "Sequenza: gambe, busto, braccia in spinta - il contrario nel ritorno."),
